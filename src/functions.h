...
namespace {
    ...
    void getSystemInfo() {
        ...
        global::systemInfoText.append("</b><br>Copyright <font face='Inter'>©</font> 2021-2026 Nicolas Mailloux and contributors<br>Special thanks to: Szybet, NiLuJe, akemnade, Rain92, Zoli");
    ...
    QString purgeHtml(QString text) {
        ...
        return text.remove(QRegularExpression("<[^>]*>"));
    }
